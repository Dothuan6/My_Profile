        ...
        >
          ...
          >
            ...
            <div className="text-xl md:text-2xl text-gray-300">
              <TypeWriter
                text="Fullstack Web Developer - Business Analyst | CRM"
                delay={3000}
                speed={100}
              />
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            },
            {
              icon: FiGlobe,
              label: "Website",
              value: "https://dothuan-profile.netlify.app/",
            },
          ].map((contact, index) => (
            <motion.div
              key={index}
      ...
      >
        ...
        >
          <p className="text-xl text-gray-300 leading-relaxed mb-6">
            Tôi là một Freelancer Web Developer với niềm đam mê mãnh liệt về
            công nghệ và phát triển web. Với kinh nghiệm trong việc xây dựng các
            ứng dụng web hiện đại và hệ thống AI/ML, tôi luôn strive để tạo ra
            những sản phẩm chất lượng cao và user-friendly.
          </p>
          <p className="text-lg text-gray-400 leading-relaxed">
            Chuyên môn của tôi bao gồm phát triển full-stack với React.js,
            Node.js, Python, Solidity và có kinh nghiệm làm việc với các dự án
            từ e-commerce đến hệ thống quản lý học tập phức tạp.
          </p>
        </motion.div>
      </motion.section>
      {/* Education Section */}
      ...
      >
        ...
        >
          ...
          <div className="border-l-4 border-blue-500 pl-6 space-y-3">
            ...
            >
              Hiện đang collab cùng{" "}
              <span className="font-bold text-pink-400">Mss. Thanh Thảo</span>,
              với ước mơ{" "}
              <span className="text-yellow-400 font-bold">ETH đạt 10k</span>{" "}
              🚀✨
            </motion.p>
          </div>
        </motion.div>
          ...
          {[
            {
              ...
              duration: "2023",
              description:
                "Phát triển và maintain các hệ thống web nội bộ, tối ưu hóa hiệu suất và user experience.",
            },
            {
              company: "TuoiTreSoft",
              ...
              description:
                "Xây dựng các ứng dụng web full-stack với React.js và Node.js, tham gia các dự án AI/ML. Đề xuất giải pháp phần mềm. Kiểm thử và thiết kế hệ thống",
            },
          ].map((exp, index) => (
            <motion.div
              key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {[
              {
                icon: FiMail,
                url: "mailto:dovanthuan@example.com",
                label: "Email",
              },
              {
                icon: FiLinkedin,
